...
class _LocationDemoState extends State<LocationDemo> {
  ...
  Future<void> _getDeviceInfo() async {
    var signature = await PackageSignature.instance.signature;
    print('签名信息SHA1: ${signature?.sha1hex.toUpperCase()}');
    print('签名信息SHA256: ${signature?.sha256hex.toUpperCase()}');
  }
